...
<head>
    ...
    <script type='text/javascript' src='<c:url value="/admin/js/jquery-2.2.3.min.js" />'></script>
    <script src="<c:url value='/admin/assets/js/jquery.2.1.1.min.js' />"></script>
    <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    
    <!-- sweetalert -->
    <script  src="<c:url value='/admin/sweetalert/sweetalert2.min.js' />"></script>
    <link rel="stylesheet" href="<c:url value='/admin/sweetalert/sweetalert2.min.css' />" />
    
     <script  src="<c:url value='/ckeditor.js' />"></script>
</head>
<body class="no-skin">
	<!-- header -->
